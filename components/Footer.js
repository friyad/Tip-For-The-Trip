...
import { FaInstagram,FaStripe,FaGooglePay,FaTwitter,FaFacebook,FaYoutube,FaCcApplePay,FaCcVisa,FaCcMastercard,FaCcAmex } from "react-icons/fa";
			...
			<div className ="bg-custom-whitegray flex flex-col text-center">
					<div className=" h-1/2 w-full flex md:flex-row flex-col p-0 justify-center gap-x-10">
						<div className="m-2 my-auto">
							<Link href="/home" >
									<a>
										<span className="text-yellow-500 font-bold text-2xl pb-4"> TIP</span>
										<span className="text-blue-500 font-bold text-2xl pb-4">for</span>
										<span className="text-red-600 font-bold text-2xl pb-4">The</span>
										<span className="text-green-600 font-bold text-2xl pb-4">TRIP</span>
									</a>
							</Link>
							<ul className="flex justify-center gap-6 pb-5 ">
									<li><a href="http://www.instagram.com"><FaInstagram className="text-3xl  text-gray-800 hover:opacity-60" /></a></li>
									<li><a href="http://www.twitter.com"><FaTwitter className="text-3xl text-blue-500 hover:opacity-60 " /></a></li>
									<li><a href="http://www.facebook.com"><FaFacebook className="text-3xl text-blue-600 hover:opacity-60" /></a></li>
									<li><a href="https://www.youtube.com"><FaYoutube className="text-3xl text-red-600 hover:opacity-60" /></a></li>
							</ul>
						</div>
						<div className="m-2">
							<p className="text-custom- font-bold text-2xl pb-4">BBQ Help Center</p>
							<ul>
								<Link href="/about" >
									<a>
						...
						<div className="m-2">
							<p className="text-custom-navgreen font-bold text-2xl pb-4">Products</p>
							<ul>
								<Link href="/about" >
									<a>
										<li className="text-black hover:text-custom-navygreen text-md pb-2 font-semibold ">
						...
						<div className="m-2">
							<ul>
								<p className="text-black font-bold text-2xl pb-4">Contact Information: </p>
